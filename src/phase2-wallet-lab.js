...
function renderPhase2WalletLab(items, csrfToken = "", notice = "", live = {}) {
  ...
  const liveCards = [
    ...
    ["Wallet stats enriched", status.performance_analyzed || 0], ["Win-rate bonuses", status.performance_bonused || 0],
